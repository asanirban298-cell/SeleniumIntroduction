...
public class Locators {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		// Proceeding for forgot password scenario
		driver.findElement(By.linkText("Forgot your password?")).click();
		Thread.sleep(2000);
		driver.findElement(By.xpath("//input[@placeholder='Name']")).sendKeys("Anirban");
		driver.findElement(By.cssSelector("input[placeholder='Email']")).sendKeys("asanirban@gmail.com");
